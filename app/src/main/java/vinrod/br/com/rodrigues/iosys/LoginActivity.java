package vinrod.br.com.rodrigues.iosys;
...
import vinrod.br.com.rodrigues.iosys.Service.Service;
import vinrod.br.com.rodrigues.iosys.models.UserAutenticationModel;
import vinrod.br.com.rodrigues.iosys.models.UserModel;

public class LoginActivity extends AppCompatActivity {

    private UserAutenticationModel userAutenticationModel; //login
    ...
    public void authenticate(String email, String password){
        ...
        userAutenticationModel = new UserAutenticationModel(email, password);
        Call call = iService.authenticate(userAutenticationModel);
        call.enqueue(new Callback<UserAutenticationModel>() {
            @Override
